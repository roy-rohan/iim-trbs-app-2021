...
class ContactPerson
{
    ...
    public function read_single()
    {
        ...
        // Bind ID
        $stmt->bindParam(":contact_person_id", $this->contact_person_id);
    ...
    {
        // Create query
        $query = 'DELETE FROM ' . $this->table . ' WHERE contact_person_id = :contact_person_id';

        // Prepare statement
        $stmt = $this->conn->prepare($query);

        // Clean data
        $this->contact_person_id = htmlspecialchars(strip_tags($this->contact_person_id));
