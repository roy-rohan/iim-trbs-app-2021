...
class Pack
{
    ...
    public function read_single()
    {
        // Create query
        $query =
            'SELECT * FROM ' . $this->table . ' WHERE pack_id = :pack_id';

        // Prepare statement
        $stmt = $this->conn->prepare($query);

        // Bind ID
        $stmt->bindParam(":pack_id", $this->pack_id);
    ...
    {
        // Create query
        $query = 'DELETE FROM ' . $this->table . ' WHERE pack_id = :pack_id';

        // Prepare statement
        $stmt = $this->conn->prepare($query);

        // Clean data
        $this->pack_id = htmlspecialchars(strip_tags($this->pack_id));
